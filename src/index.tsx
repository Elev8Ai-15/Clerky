      ...
      <div class="fade-in flex flex-col h-full rounded-xl overflow-hidden border border-slate-700" style="max-height:calc(100vh - 73px); background: #020617;">
        ...
        <div class="px-4 py-3 border-b border-slate-800" style="background:#0f172a">
          ...
          <div class="flex flex-wrap gap-1.5">
            <button onclick="injectChip('Research Kansas case law on comparative negligence under K.S.A. 60-258a — cite 10th Circuit and KS Supreme Court holdings')" class="text-xs py-1 px-3 rounded-full border text-slate-300 hover:text-emerald-400 hover:border-emerald-700 transition-all" style="background:#1e293b; border-color:#334155">\u2696\uFE0F KS case law</button>
            <button onclick="injectChip('Draft a demand letter under Kansas law — include K.S.A. 60-258a proportional fault analysis and K.S.A. 60-513 SOL deadline')" class="text-xs py-1 px-3 rounded-full border text-slate-300 hover:text-emerald-400 hover:border-emerald-700 transition-all" style="background:#1e293b; border-color:#334155">\uD83D\uDCDD Draft demand letter</button>
            <button onclick="injectChip('Confirm the 2-year statute of limitations under K.S.A. 60-513 for this claim — flag discovery rule exceptions and presuit requirements')" class="text-xs py-1 px-3 rounded-full border text-slate-300 hover:text-emerald-400 hover:border-emerald-700 transition-all" style="background:#1e293b; border-color:#334155">\u23F0 KS SOL check</button>
            <button onclick="injectChip('Analyze K.S.A. 60-258a: 50% comparative fault bar, proportional-only fault allocation (no joint and several), and empty-chair defense implications')" class="text-xs py-1 px-3 rounded-full border text-slate-300 hover:text-emerald-400 hover:border-emerald-700 transition-all" style="background:#1e293b; border-color:#334155">\u2696\uFE0F 50% bar / proportional fault</button>
